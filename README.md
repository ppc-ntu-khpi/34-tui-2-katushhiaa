...
![](https://github.com/ppc-ntu-khpi/34-tui-2-katushhiaa/blob/master/firstWork.jpg "First Work")

### Завдання на "п'ять"

1.Додайте ще одну команду - report, яка має виводити звіт за клієнтами.
...
public class TUIdemo {
    ...
    public static void main(String[] args) {
        TUIdemo tuiDemo = new TUIdemo();
        tuiDemo.init();
        tuiDemo.readCustomerData("C:\\Users\\kanur\\OneDrive\\Documents\\NetBeansProjects\\TUIdemo\\src\\test.dat");
        tuiDemo.run();
    }
}
...
**Скріншоти виконання програми(на ньому я як продемонструвала команду report, так і завдання, яке на "чотири")**

![](https://github.com/ppc-ntu-khpi/34-tui-2-katushhiaa/blob/master/for5_Work1.jpg "First Part")
![](https://github.com/ppc-ntu-khpi/34-tui-2-katushhiaa/blob/master/for5_Work2.jpg "Second_Part")
